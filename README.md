...
## 🖥️ Running Text (Star Wars Effect)

<div style="font-size: 24px; color: #fff; font-family: 'Courier New', monospace; text-align: center;">
    <marquee behavior="scroll" direction="left">Hi, my name is Rafi!</marquee>
</div>
